    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (searchController.text.isNotEmpty) {
          ...
          contact.firstName.toLowerCase().contains(searchController.text.toLowerCase()) ||
              contact.lastName.toLowerCase().contains(searchController.text.toLowerCase())).toList();
        }

        //category
        if (selectedCategory != null) {
          contacts = contacts.where((contact) => contact.category == selectedCategory).toList();
        }
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              leading: CircleAvatar(backgroundImage: (contact.imagePath != null
              ?  FileImage(File(contact.imagePath!))
              : AssetImage('assets/default_avatar.jpg')) as ImageProvider,
            ),
            //   leading: CircleAvatar(backgroundImage: contact.imagePath != null ? Image.network(contact.imagePath!) :
            //   AssetImage('assets/defalt_avatar.jpg')),
